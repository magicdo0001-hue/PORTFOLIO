...
export class ArchiveScene {
  ...
  constructor(
    ...
    this.scene.background = new THREE.Color(portfolioTheme.background);
    this.scene.fog = new THREE.Fog(portfolioTheme.background, 22, 47);
    ...
    const floor = new THREE.Mesh(
      ...
      new THREE.MeshStandardMaterial({ color: portfolioTheme.floor, roughness: 0.95 }),
    );
